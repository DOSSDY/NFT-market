...
import { Card, Image, Tooltip, Modal, Input, Alert, Badge } from "antd";
...
function NFTTokenIds({ inputValue, setInputValue }) {
  ...
  const queryMarketItems = useMoralisQuery("ListForsale");
  ...
  async function updateSoldMarketItem() {
    ...
    const marketList = Moralis.Object.extend("ListForsale");
  ...
  return (
    <>
      <div style={styles.NFTs}>
        {/* nft inside collection and owned nft */}
